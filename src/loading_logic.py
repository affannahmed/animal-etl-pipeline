...
class AnimalLoader:
    def __init__(self, client, batch_size: int = 100) -> None:
        self.client = client
        self.batch_size = batch_size
        self.total_loaded = 0

    def load_animals(self, animals_list: List[Dict[str, Any]]) -> int:
        """Load animals in batches to /animals/v1/home endpoint."""
